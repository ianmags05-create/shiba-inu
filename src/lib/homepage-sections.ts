...
export const homepageSections: HomepageSection[] = [
  ...
  { key: "gallery", label: "Gallery", description: "A visual tour of the shop, hotel and facilities.", imageSlots: ["gallery.featured", "gallery.image_2", "gallery.image_3", "gallery.image_4", "gallery.image_5", "gallery.imae_6", "gallery.imae_7", "gallery.imae_8"], fallbackImage: "/assets/photos/storefront.webp", visible: true },
